...
#define TASK_THREAD_RA 992 /* offsetof(struct task_struct, thread.ra) */
#define TASK_THREAD_SP 996 /* offsetof(struct task_struct, thread.sp) */
#define TASK_THREAD_S0 1000 /* offsetof(struct task_struct, thread.s[0]) */
#define TASK_THREAD_S1 1004 /* offsetof(struct task_struct, thread.s[1]) */
#define TASK_THREAD_S2 1008 /* offsetof(struct task_struct, thread.s[2]) */
#define TASK_THREAD_S3 1012 /* offsetof(struct task_struct, thread.s[3]) */
#define TASK_THREAD_S4 1016 /* offsetof(struct task_struct, thread.s[4]) */
#define TASK_THREAD_S5 1020 /* offsetof(struct task_struct, thread.s[5]) */
#define TASK_THREAD_S6 1024 /* offsetof(struct task_struct, thread.s[6]) */
#define TASK_THREAD_S7 1028 /* offsetof(struct task_struct, thread.s[7]) */
#define TASK_THREAD_S8 1032 /* offsetof(struct task_struct, thread.s[8]) */
#define TASK_THREAD_S9 1036 /* offsetof(struct task_struct, thread.s[9]) */
#define TASK_THREAD_S10 1040 /* offsetof(struct task_struct, thread.s[10]) */
#define TASK_THREAD_S11 1044 /* offsetof(struct task_struct, thread.s[11]) */
#define TASK_THREAD_SP 996 /* offsetof(struct task_struct, thread.sp) */
#define TASK_STACK 28 /* offsetof(struct task_struct, stack) */
...
#define TASK_TI_KERNEL_SP 12 /* offsetof(struct task_struct, thread_info.kernel_sp) */
#define TASK_TI_USER_SP 16 /* offsetof(struct task_struct, thread_info.user_sp) */
#define TASK_TI_CPU 20 /* offsetof(struct task_struct, thread_info.cpu) */
#define TASK_THREAD_F0 1048 /* offsetof(struct task_struct, thread.fstate.f[0]) */
#define TASK_THREAD_F1 1056 /* offsetof(struct task_struct, thread.fstate.f[1]) */
#define TASK_THREAD_F2 1064 /* offsetof(struct task_struct, thread.fstate.f[2]) */
#define TASK_THREAD_F3 1072 /* offsetof(struct task_struct, thread.fstate.f[3]) */
#define TASK_THREAD_F4 1080 /* offsetof(struct task_struct, thread.fstate.f[4]) */
#define TASK_THREAD_F5 1088 /* offsetof(struct task_struct, thread.fstate.f[5]) */
#define TASK_THREAD_F6 1096 /* offsetof(struct task_struct, thread.fstate.f[6]) */
#define TASK_THREAD_F7 1104 /* offsetof(struct task_struct, thread.fstate.f[7]) */
#define TASK_THREAD_F8 1112 /* offsetof(struct task_struct, thread.fstate.f[8]) */
#define TASK_THREAD_F9 1120 /* offsetof(struct task_struct, thread.fstate.f[9]) */
#define TASK_THREAD_F10 1128 /* offsetof(struct task_struct, thread.fstate.f[10]) */
#define TASK_THREAD_F11 1136 /* offsetof(struct task_struct, thread.fstate.f[11]) */
#define TASK_THREAD_F12 1144 /* offsetof(struct task_struct, thread.fstate.f[12]) */
#define TASK_THREAD_F13 1152 /* offsetof(struct task_struct, thread.fstate.f[13]) */
#define TASK_THREAD_F14 1160 /* offsetof(struct task_struct, thread.fstate.f[14]) */
#define TASK_THREAD_F15 1168 /* offsetof(struct task_struct, thread.fstate.f[15]) */
#define TASK_THREAD_F16 1176 /* offsetof(struct task_struct, thread.fstate.f[16]) */
#define TASK_THREAD_F17 1184 /* offsetof(struct task_struct, thread.fstate.f[17]) */
#define TASK_THREAD_F18 1192 /* offsetof(struct task_struct, thread.fstate.f[18]) */
#define TASK_THREAD_F19 1200 /* offsetof(struct task_struct, thread.fstate.f[19]) */
#define TASK_THREAD_F20 1208 /* offsetof(struct task_struct, thread.fstate.f[20]) */
#define TASK_THREAD_F21 1216 /* offsetof(struct task_struct, thread.fstate.f[21]) */
#define TASK_THREAD_F22 1224 /* offsetof(struct task_struct, thread.fstate.f[22]) */
#define TASK_THREAD_F23 1232 /* offsetof(struct task_struct, thread.fstate.f[23]) */
#define TASK_THREAD_F24 1240 /* offsetof(struct task_struct, thread.fstate.f[24]) */
#define TASK_THREAD_F25 1248 /* offsetof(struct task_struct, thread.fstate.f[25]) */
#define TASK_THREAD_F26 1256 /* offsetof(struct task_struct, thread.fstate.f[26]) */
#define TASK_THREAD_F27 1264 /* offsetof(struct task_struct, thread.fstate.f[27]) */
#define TASK_THREAD_F28 1272 /* offsetof(struct task_struct, thread.fstate.f[28]) */
#define TASK_THREAD_F29 1280 /* offsetof(struct task_struct, thread.fstate.f[29]) */
#define TASK_THREAD_F30 1288 /* offsetof(struct task_struct, thread.fstate.f[30]) */
#define TASK_THREAD_F31 1296 /* offsetof(struct task_struct, thread.fstate.f[31]) */
#define TASK_THREAD_FCSR 1304 /* offsetof(struct task_struct, thread.fstate.fcsr) */
