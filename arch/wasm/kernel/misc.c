...
initcall_entry_t __clk_of_table[];
initcall_entry_t __start_builtin_fw[];
initcall_entry_t __end_builtin_fw[];
initcall_entry_t __start___modver[];
initcall_entry_t __stop___modver[];
